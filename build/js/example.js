...
var ModalEffects = function (blueprint3d) {
  ...
  function init() {
    ...
    blueprint3d.model.scene.addEventListener(
      BP3DJS.EVENT_ITEM_LOADING,
      function () {
        itemsLoading += 1;
        update();
      },
...
var TextureSelector = function (blueprint3d, sideMenu) {
  ...
  function init() {
    ...
    three.addEventListener(BP3DJS.EVENT_NOTHING_CLICKED, () => {
      reset();
    });
    three.addEventListener(BP3DJS.EVENT_ITEM_SELECTED, (o) => {
      reset();
    });
