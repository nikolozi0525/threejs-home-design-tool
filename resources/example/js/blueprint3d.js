...
(function (BP3D) {
  ...
  (function (Core) {
    ...
    var Utils = (function () {
      ...
      Utils.polygonInsidePolygon = function (
        insideCorners,
        outsideCorners,
        startX,
        startY,
      ...
      Utils.polygonOutsidePolygon = function (
        insideCorners,
        outsideCorners,
        startX,
        startY,
  ...
  (function (Items) {
    ...
    var Item = (function (_super) {
      ...
      Item.prototype.rotate = function (intersection) {
        if (intersection) {
          var angle = BP3D.Core.Utils.angle(
            0,
            1,
      ...
      Corner.prototype.mergeWithIntersected = function () {
        ...
        for (var i = 0; i < this.floorplan.getWalls().length; i++) {
          ...
          if (
            ...
            var intersection = BP3D.Core.Utils.closestPointOnLine(
              this.x,
              this.y,
              wall.getStart().x,
              wall.getStart().y,
...
(function (BP3D) {
  ...
  (function (Model) {
    ...
    var HalfEdge = (function () {
       ...
       *
       */
      HalfEdge.prototype.setTexture = function (
        textureUrl,
        textureStretch,
        textureScale,
      ) {
      ...
      HalfEdge.prototype.computeTransforms = function (
        transform,
        invTransform,
        start,
        end,
      ...
      HalfEdge.prototype.distanceTo = function (x, y) {
        // x, y, x1, y1, x2, y2
        return BP3D.Core.Utils.pointDistanceFromLine(
          x,
          y,
  ...
  (function (Model) {
    ...
    var Wall = (function () {
      ...
      function Wall(start, end) {
        ...
        /** Wall thickness. */
        this.thickness = BP3D.Core.Configuration.getNumericValue(
          BP3D.Core.configWallThickness,
        );
        /** Wall height. */
        this.height = BP3D.Core.Configuration.getNumericValue(
          BP3D.Core.configWallHeight,
        );
...
(function (BP3D) {
  ...
  (function (Model) {
    ...
    var Room = (function () {
       ...
       */
      Room.prototype.setTexture = function (
        textureUrl,
        textureStretch,
        textureScale,
      ) {
  ...
  (function (Model) {
    ...
    var Floorplan = (function () {
      ...
      Floorplan.prototype.findRooms = function (corners) {
        ...
        //remove CW loops
        var uniqueCCWLoops = BP3D.Core.Utils.removeIf(
          uniqueLoops,
          BP3D.Core.Utils.isClockwise,
        );
    ...
    var FloorItem = (function (_super) {
      ...
      FloorItem.prototype.isValidPosition = function (vec3) {
        ...
        for (var i = 0; i < rooms.length; i++) {
          if (
            BP3D.Core.Utils.pointInPolygon(
              vec3.x,
              vec3.z,
              rooms[i].interiorCorners,
            ) &&
            !BP3D.Core.Utils.polygonPolygonIntersect(
              corners,
              rooms[i].interiorCorners,
            )
          ) {
...
(function (BP3D) {
  ...
  (function (Model) {
    ...
    var Scene = (function () {
       ...
       */
      Scene.prototype.addItem = function (
        itemType,
        fileName,
        metadata,
        position,
  ...
  (function (Floorplanner) {
    ...
    var FloorplannerView = (function () {
      ...
      FloorplannerView.prototype.drawWall = function (wall) {
        ...
        if (
          hover &&
          this.viewmodel.mode == Floorplanner.floorplannerModes.DELETE
        ) {
          color = deleteColor;
        } else if (hover) {
      ...
      FloorplannerView.prototype.drawEdgeLabel = function (edge) {
        ...
        this.context.strokeText(
          BP3D.Core.Dimensioning.cmToMeasure(length),
      ...
      /** */
      FloorplannerView.prototype.drawLine = function (
        startX,
        startY,
        endX,
        endY,
      ...
      /** */
      FloorplannerView.prototype.drawPolygon = function (
        xArr,
        yArr,
        fill,
        fillColor,
      ...
      /** */
      FloorplannerView.prototype.drawCircle = function (
        centerX,
        centerY,
        radius,
        fillColor,
  ...
  (function (Floorplanner_1) {
    ...
    var Floorplanner = (function () {
      ...
      function Floorplanner(canvas, floorplan) {
        ...
        this.view = new Floorplanner_1.FloorplannerView(
          this.floorplan,
          this,
          canvas,
        );
      ...
      Floorplanner.prototype.updateTarget = function () {
        if (
          this.mode == Floorplanner_1.floorplannerModes.DRAW &&
          this.lastNode
        ) {
      ...
      Floorplanner.prototype.mousemove = function (event) {
        ...
        if (
          this.mode == Floorplanner_1.floorplannerModes.DRAW ||
          (this.mode == Floorplanner_1.floorplannerModes.MOVE && this.mouseDown)
        ) {
          this.updateTarget();
        }
        ...
        // dragging
        if (
          this.mode == Floorplanner_1.floorplannerModes.MOVE &&
          this.mouseDown
        ) {
          if (this.activeCorner) {
  ...
  (function (Three) {
    Three.Controller = function (three, model, camera, element, controls, hud) {
      ...
      this.getIntersections = function (
        ...
        if (onlyVisible) {
          intersections = BP3D.Core.Utils.removeIf(
            intersections,
    ...
    Three.Edge = function (scene, edge, controls) {
      ...
      function makeWall(start, end, transform, invTransform, material) {
        ...
        function vertexToUv(vertex) {
          var x =
            BP3D.Core.Utils.distance(v1.x, v1.z, vertex.x, vertex.z) /
            totalDistance;
...
(function (BP3D) {
  ...
  var Blueprint3d = (function () {
    ...
    function Blueprint3d(options) {
      ...
      this.three = new BP3D.Three.Main(
        this.model,
      ...
      if (!options.widget) {
        this.floorplanner = new BP3D.Floorplanner.Floorplanner(
...
(function (BP3D) {
  ...
  (function (Core) {
    ...
    function isLogging(context, level) {
      return (
        Core.logContext === ELogContext.All ||
